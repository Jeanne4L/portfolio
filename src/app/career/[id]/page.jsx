        ...
        return(
            <>
                ...
                <div className={`container ${styles.container}`}>
                    ...
                    <div className={`${styles.paragraph} ${xp.softSkills ? '' : styles.texts}`}>
                        {xp.id === 'commerce' && 
                            <>
